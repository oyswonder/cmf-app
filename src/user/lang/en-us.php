...
return [
    ...
    "LOGIN_TIMES"                   => 'Number Times',
    'USERNAME_OR_EMAIL_EMPTY'       => "User name cannot be empty!",
    'PASSWORD_REQUIRED'             => "Password cannot be empty!",
    'CAPTCHA_REQUIRED'              => "verification code must be filled!",
